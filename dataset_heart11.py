...
def afficher_resultats(y_vrai, y_pred, nom_modele):
...
afficher_resultats(y_test, pred_arbre, "l'Arbre de Décision")
afficher_resultats(y_test, pred_foret, "la Forêt Aléatoire")
